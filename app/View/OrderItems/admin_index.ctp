<div class="orderItems index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('charges');?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($orderItem['Order']['order_id'], array('controller' => 'orders', 'action' => 'view', $orderItem['Order']['order_id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($orderItem['Artwork']['title'], array('controller' => 'artworks', 'action' => 'view', $orderItem['Artwork']['id'])); ?>
		</td>
		<td><?php echo h($orderItem['OrderItem']['item_type']); ?>&nbsp;</td>
		<td><?php echo h($orderItem['OrderItem']['amount']); ?>&nbsp;</td>
		<td><?php echo h($orderItem['OrderItem']['charges']); ?>&nbsp;</td>
